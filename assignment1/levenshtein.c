...
int levenshteinDistance(char *a, int aLen, char *b, int bLen);
...
{ 
    ...
    printf("Levenshtein distance: %d\n", levenshteinDistance(X, strlen(X), Y, strlen(Y)));
...
int levenshteinDistance(char *a, int aLen, char *b, int bLen) {
    ...
    val1 = levenshteinDistance(a, aLen - 1, b, bLen) + 1;
    val2 = levenshteinDistance(a, aLen, b, bLen - 1) + 1;
    val3 = levenshteinDistance(a, aLen - 1, b, bLen - 1) + cost;

    return min3(val1, val2, val3);
}