...
{ 
	...
	// Calculates and prints out similarity percentage
	printf("Percentage: %f%%\n", (double)numberOfSame/(double)(strlen(X) > strlen(Y) ? strlen(X) : strlen(Y))*100);
	printf("Calculated as (common markers)/(number of characters in the longest genome) * 100\n\n");
	
	printf("Hamming Distance: %d\n", strlen(alignX) - numberOfSame);
